...
cat  /tmp/imm_instrs | parallel -j 1 "$PROCESSPL --check_stoke --file concrete_instances/memory-variants/{}/check_stoke.txt --instructions_path concrete_instances/memory-variants/{}/instructions --use_updated_tc --testid 00 --stokedir /home/sdasgup3/Github/develop_stoke/ --no_strata_handler"
