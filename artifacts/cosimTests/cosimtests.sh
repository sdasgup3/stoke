...
#cat log                                   | parallel "$PROCESSPL --prepare_concrete  --opcode {} --workdir concrete_instances/memory-variants/{}"
...
#cat  /tmp/non_imm_instrs | parallel "$PROCESSPL --opcode  {}  --instructions_path concrete_instances/memory-variants/{}/instructions/ --update_tc --testid 00"
#cat  /tmp/imm_instrs | parallel "$PROCESSPL --opcode  {}  --instructions_path concrete_instances/memory-variants/{}/instructions/ --update_tc --testid 00"
#cat  log | parallel "$PROCESSPL --opcode  {}  --instructions_path concrete_instances/memory-variants/{}/instructions/ --update_tc --testid 00"
...
#cat  /tmp/non_imm_instrs | parallel -j 1 "$PROCESSPL --check_stoke --file concrete_instances/memory-variants/{}/check_stoke.txt --instructions_path concrete_instances/memory-variants/{}/instructions --use_updated_tc --testid 00 --stokedir /home/sdasgup3/Github/develop_stoke/ --no_strata_handler"
cat  log | parallel -j 1 "$PROCESSPL --check_stoke --file concrete_instances/memory-variants/{}/check_stoke.txt --instructions_path concrete_instances/memory-variants/{}/instructions  --use_updated_tc --testid 00 --stokedir /home/sdasgup3/Github/develop_stoke/ --no_strata_handler"
